...
class Date(ABC):
    def __init__(self, year, month, day):
        self.my_data = date(year, month, day)
...
class USADate(Date):
    def format(self):
        return self.iso_format().strftime('%m-%d-%Y')


class ItalianDate(Date):
    def format(self):
        return self.iso_format().strftime('%d/%m/%Y')
...
for year_, day_, month_ in dates:
    usadate = USADate(year_, day_, month_)
...
for year_, day_, month_ in dates:
    italiandate = ItalianDate(year_, day_, month_)
